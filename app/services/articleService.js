...
5.  सारांश 80 से 100 शब्दों में, **आपके अपने शब्दों में लिखा जाना चाहिए**, जिसमें मूल शीर्षक और विवरण दोनों की मुख्य जानकारी शामिल हो।
...
5.  The summary must be a concise 80-100 words, **written in your own words**, that integrates the key information from both the original title and description.
...
\`\`\`json
{
  ...
  "summary": "<A 80–100 word summary in English, fully paraphrased>"
}
\`\`\`
